...
export function ContentDetailModal({ content, isOpen, onClose }: ContentDetailModalProps) {
    ...
    const downloadFormats = [
        { value: 'original', label: 'Format Original', size: content.size || 0 },
        { value: 'compressed', label: 'Compressé', size: (content.size || 0) * 0.7 },
        { value: 'web', label: 'Optimisé Web', size: (content.size || 0) * 0.5 }
    ]
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="grid grid-cols-2 gap-4 text-sm">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span>Créateur: {content.author}</span>
                                </div>
                                <div className="flex items-center gap-2">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <span>{formatFileSize(content.size || 0)}</span>
                                </div>
                                <div className="flex items-center gap-2">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm text-muted-foreground">
                                    {content.rating}/5 ({content.reviews || 0} avis)
                                </span>
                            </div>
                        </div>
                    </div>
